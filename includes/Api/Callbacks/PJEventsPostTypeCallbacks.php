<?php
/**
 * PickleJar Live for Artists & Venues - Events Post Type Callbacks Class.
 *
...
/**
 * Class PJEventsPostTypeCallbacks
 *
 * @extends BaseController
 * @since 1.0.0
 * @package Picklejar\Api\Callbacks
 */
class PJEventsPostTypeCallbacks extends BaseController {
	...
	public function get_option_name() {
		return 'picklejar_integration_plugin_events_post';
	}
	...
	public function get_option_group() {
		return 'picklejar_integration_plugin_events_post_group';
	}

	/**
	 * Function render event preview.
	 *
	 * @return void
	 * @since 1.0.0
	 * @access public
	 */
	public function pj_render_event_preview() {
		require_once $this->plugin_path . 'manager/events-layout/partials/pj-events-preview.php';
	}
	...
	public function shortcode_page() {
		return require_once "$this->plugin_path/manager/dashboard/events-shortcode-page.php";
	}
}
